...
**Function set:** the function set(x, y, [r, g, b, a]) changes the RGBA value of a pixel. The r, g, b and a values range is from 0 to 255.
**Function update:** the function update() render the image data to the screen. Before it, changes are not visible.
